...
public class NaviView extends LinearLayout {
    ...
    public NaviView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        mBigIconSrc = ta.getResourceId(R.styleable.NaviView_bigIconSrc, R.drawable.big);
        mSmallIconSrc = ta.getResourceId(R.styleable.NaviView_smallIconSrc, R.drawable.small);
